...
function jc_mods_styles() {
	...
	<style>
		...
		.jc-mod-card { background:var(--jc-panel); border:1px solid var(--jc-border); border-radius:16px; padding:14px; display:grid; grid-template-columns:96px 1fr; gap:14px; position:relative; overflow:hidden; box-shadow:0 16px 44px rgba(0,0,0,0.35); transition:transform .2s, border-color .2s, box-shadow .2s; }
		...
		.jc-mod-thumb img { width:100%; height:100%; min-height:96px; object-fit:cover; border-radius:12px; background:#050712; border:1px solid var(--jc-border); }
