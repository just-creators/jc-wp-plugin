...
add_shortcode( 'jc-contact-form', function() {
    ...
    <div class="jc-bewerbung-wrap">
        <div class="jc-card">
            <h2 class="jc-h">💬 Kontakt — JustCreators</h2>
            <p style="line-height: 1.7; margin-bottom: 25px; color: #b5bac1;">
                Du hast Fragen oder ein Anliegen? Schreib uns eine Nachricht und wir melden uns so schnell wie möglich bei dir!
            </p>
        ...
        if ( $success_message ) {
            ...
            <form method="post" id="jc-contact-form">
                ...
                <div class="jc-note" style="margin-top: 10px;">
                    ℹ️ <strong>Hinweis:</strong> Überprüfe deine Angaben bevor du die Nachricht absendest!
                </div>
